...
11. cd niccolo
12. bash ./quick_quicklisp.sh (the script will download, install most of the libraries and will help you to configure ASDF);
...
23. point your browser to https://+hostname+:8443/lab/add-admin/
 where \+hostname\+ is the value of the variable setted in point 19.
