...
(define-constant +managing-chemical-compatibility+   "managing_chemical_compatibility" :test #'equal)

(define-constant +good-fume-cupboard-rel+            "good_fume_cupboard_rel"          :test #'equal)
